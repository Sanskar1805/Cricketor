...
<body style="background-color:beige;color:#1B2430;font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">
    <form action="" method="POST">
        <div class="upp" >
            <div class="upperdiv">
                <label style="font-family:fantasy;font-size:40px">Current Batting Team : Team2</label>
                <br>
                <!--<input type="number" name="team_name">-->
                <button name="team_name-b" class="btn btn-outline-dark">Start</button>
                <br>
                <a style="text-decoration:dotted;color:darkgray;font-weight:bolder" href="man-scoreboard.php">Move to team1</a>
            </div>
            <div class="upperdiv">
