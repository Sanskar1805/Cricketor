...
<body>
    ...
    <form id  = "name-form" action="" method="POST">
        ...
        <input type="text" name="match-code" placeholder="Enter-here..." required="required"/>
                                    <br>
                                    <br><br>-->
    <label>Add Team2 Player's Name : </label> 
				<br />
				<div id="playerdiv">
    ...
    <a href="playerinfo.php">Move to team1</a>
    <br>
    <br>
    <br>
...
if(ISSET($_POST['save'])){
		...
		mysqli_query($link, "INSERT INTO `player_details` VALUES('', '$pname', 2,'$code',0)") ;//or die(mysqli_error());
 
 
		header("location: playerinfo2.php");
	}
?>